...
=======
  ...
  public static class ProgramContext extends ParserRuleContext {
    public TerminalNode EOF() {
      return getToken(ReflangParser.EOF, 0);
    }
  ...
  public static class VardeclContext extends ParserRuleContext {
    ...
    public TerminalNode ID() {
      return getToken(ReflangParser.ID, 0);
    }
...
=======
  ...
  public static class FndeclContext extends ParserRuleContext {
    ...
    public TerminalNode FN() {
      return getToken(ReflangParser.FN, 0);
    }
  ...
  public static class BoolContext extends TypeContext {
    public TerminalNode TYPE_BOOL() {
      return getToken(ReflangParser.TYPE_BOOL, 0);
    }

    public BoolContext(TypeContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class StringContext extends TypeContext {
    public TerminalNode TYPE_STRING() {
      return getToken(ReflangParser.TYPE_STRING, 0);
    }
  ...
  public static class IntContext extends TypeContext {
    public TerminalNode TYPE_INT() {
      return getToken(ReflangParser.TYPE_INT, 0);
    }

    public IntContext(TypeContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class NmbContext extends ExprContext {
    public TerminalNode NUMBER() {
      return getToken(ReflangParser.NUMBER, 0);
    }

    public NmbContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class LtContext extends ExprContext {
    ...
    public LtContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class BlitContext extends ExprContext {
    ...
    public BlitContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class EqContext extends ExprContext {
    ...
    public EqContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class GtContext extends ExprContext {
    ...
    public GtContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class StrContext extends ExprContext {
    public TerminalNode STRING() {
      return getToken(ReflangParser.STRING, 0);
    }

    public StrContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class LeContext extends ExprContext {
    ...
    public LeContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class FncContext extends ExprContext {
    ...
    public FncContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class GeContext extends ExprContext {
    ...
    public GeContext(ExprContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class TrueContext extends Bool_literalContext {
    public TerminalNode TRUE() {
      return getToken(ReflangParser.TRUE, 0);
    }

    public TrueContext(Bool_literalContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class FalseContext extends Bool_literalContext {
    public TerminalNode FALSE() {
      return getToken(ReflangParser.FALSE, 0);
    }

    public FalseContext(Bool_literalContext ctx) {
      copyFrom(ctx);
    }
