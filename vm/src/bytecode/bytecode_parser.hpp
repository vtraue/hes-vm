...
struct Parser {
  ...
  template <>
  std::optional<Type_Id> parse(Reader& reader) {
  ...
  template <>
  std::optional<Section_Id> parse(Reader& reader) {
    uint8_t id = reader.get<uint8_t>();
    return section_id_from_byte(id);
  }

  template <>
  std::optional<Function_Type> parse(Reader& reader) {
  ...
  template <>
  std::optional<Type_Section> parse(Reader& reader) {
  ...
  template <>
  std::optional<Type_Index> parse(Reader& reader) {
  ...
  template <>
  std::optional<Function_Section> parse(Reader& reader) {
  ...
  template <>
  std::optional<std::string_view> parse(Reader& reader) {
  ...
  template <>
  std::optional<Export> parse(Reader& reader) {
  ...
  template <>
  std::optional<Imm::Blocktype> parse(Reader& reader) {
  ...
  template <>
  std::optional<Expression> parse(Reader& reader) {
    int depth = 0;
  ...
  template <>
  std::optional<Locals> parse(Reader& reader) {
    auto count = reader.get<uint32_t>();
  ...
  template <>
  std::optional<Code> parse(Reader& reader) {
  ...
  template <>
  std::optional<Code_Section> parse(Reader& reader) {
    auto count = reader.get<uint32_t>();
    ...
    if (count > 0) {
      for (uint32_t i = 0; i < count; i++) {
        auto code = this->parse<Code>(reader);
        if (!code) {
