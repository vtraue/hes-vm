...
record TypedBinOP(TypedExpression lhs, BinopType op, TypedExpression rhs)
...
record TypedFncall(String name, Function type, Optional<TypedFncallArgs> params)
        implements TypedExpression {
    @Override
    public Type getType() {
...
record TypedVarDecl(TypedId id, Type type, Optional<TypedExpression> expr)
